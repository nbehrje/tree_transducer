...
class DBTTTests(unittest.TestCase):
    ...
    def testNewStatesSymbolsInTransitions(self):
        self.assertRaises(ValueError, DBTT, ["qA"],["qA"],["A"],["Z"],{(("qB",),"A"):[("qA",Tree("Z"))]})
        self.assertRaises(ValueError, DBTT, ["qA"],["qA"],["A"],["Z"],{(("qA",),"B"):[("qA",Tree("Z"))]})
        self.assertRaises(ValueError, DBTT, ["qA"],["qA"],["A"],["Z"],{(("qA",),"A"):[("qB",Tree("Z"))]})
        self.assertRaises(ValueError, DBTT, ["qA"],["qA"],["A"],["Z"],{(("qB",),"A"):[("qA",Tree("Y"))]})
    ...
    def testTransductionWrongState(self):
        transducer = DBTT(["qS","qA","qB","qT"],["qS"],["A","B","S"],["A","B","S"],{
                                                        ...
                                                        (tuple(), "B"):[("qB", Tree("B"))]})
        in_tree = Tree("S", [Tree("A"), Tree("S", [Tree("A"), Tree("B")]), Tree("B")])
        self.assertEqual(transducer.transduce(in_tree), [])
    ...
    def testEpsilon(self):
        self.assertRaises(ValueError, DBTT, ["qA"],["qA"],["A"],["Z"],{(("qB",),""):[("qA",Tree("Z"))]})
